class personaje{
  ...
  personaje(int at_, int at2_, int at3_, int ps_, int def_, int vel_){
    at = at_;
    at2 = at2_;
    at3 = at3_;
    ps = ps_;
